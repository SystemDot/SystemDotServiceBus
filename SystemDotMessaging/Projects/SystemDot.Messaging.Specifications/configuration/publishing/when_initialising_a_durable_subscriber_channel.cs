...
namespace SystemDot.Messaging.Specifications.configuration.publishing
{
    ...
    public class when_initialising_a_durable_subscriber_channel : WithMessageConfigurationSubject
    {
        ...
        Because of = () => Configuration.Configure.Messaging()
            ...
            .OpenChannel(ChannelName).ForSubscribingTo(PublisherName).WithPersistence()
            .Initialise();

        It should_send_a_request_for_non_persistent_subscriber_channel = () =>
            MessageSender.SentMessages.Single().GetSubscriptionRequestSchema().IsPersistent.ShouldBeTrue();
    }
}