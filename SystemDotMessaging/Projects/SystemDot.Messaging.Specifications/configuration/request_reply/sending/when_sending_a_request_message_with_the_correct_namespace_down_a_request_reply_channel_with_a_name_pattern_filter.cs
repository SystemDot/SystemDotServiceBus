...
namespace SystemDot.Messaging.Specifications.configuration.request_reply.sending
{
    ...
    public class when_sending_a_request_message_with_the_correct_namespace_down_a_request_reply_channel_with_a_name_pattern_filter : WithMessageConfigurationSubject
    {
        static IBus bus;
