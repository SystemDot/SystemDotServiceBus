...
namespace SystemDot.Messaging.Specifications.configuration.request_reply.recieving
{
    ...
    public class when_replying_with_a_message_on_a_request_reply_channel_with_another_setup : WithMessageConfigurationSubject
    {
        ...
        Establish context = () =>
        {
            ...
            MessageReciever.RecieveMessage(CreateReceiveablePayload(1, "TestSender", ChannelName, PersistenceUseType.RequestSend));
        };
