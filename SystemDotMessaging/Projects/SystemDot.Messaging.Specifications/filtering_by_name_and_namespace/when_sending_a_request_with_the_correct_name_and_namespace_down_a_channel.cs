        ...
        Establish context = () => 
            Configuration.Configure.Messaging()
                ...
                .OpenChannel("Test")
                    ...
                    .OnlyForMessages().WithNamespaceAndNamePattern("filtering_by_name_and_namespace", "Name")
                .Initialise();

        Because of = () => Bus.Send(new TestNameAndNamespaceMessage());

        It should_pass_the_message_through = () =>
           GetServer().SentMessages.First().DeserialiseTo<TestNameAndNamespaceMessage>().Should().NotBeNull();
    }
}