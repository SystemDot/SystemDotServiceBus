...
namespace SystemDot.Messaging.Specifications.authentication_for_request_reply
{
    ...
    public class when_receiving_a_request_without_a_session_on_a_server_requiring_authentication 
        : WithHttpServerConfigurationSubject
    {
        ...
        It should_not_handle_the_message_in_the_registered_handler = () => handler.HandledMessages.Should().BeEmpty();
    }
}