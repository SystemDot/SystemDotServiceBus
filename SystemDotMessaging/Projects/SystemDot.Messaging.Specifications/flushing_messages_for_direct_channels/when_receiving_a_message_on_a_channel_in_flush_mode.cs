...
namespace SystemDot.Messaging.Specifications.flushing_messages_for_direct_channels
{
    ...
    public class when_receiving_a_message_on_a_channel_in_flush_mode : WithMessageConfigurationSubject
    {
        ...
        Establish context = () =>
        {
            ...
            Configuration.Configure.Messaging()
                ...
                .OpenDirectChannel(ReceiverChannel).ForRequestReplyReceiving().InFlushMessagesMode()
