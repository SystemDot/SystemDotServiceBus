...
{
    public class when_a_recieved_message_is_sent_twice_and_the_specified_time_period_has_passed_again : WithSubject<MessageRepeater>
    {
        ...
        Establish context = () =>
        {
            ...
            scheduler = new TestTaskScheduler(2);
