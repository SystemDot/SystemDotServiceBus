...
namespace SystemDot.Messaging.Specifications.repeating_escalating
{
        ...
        : WithMessageConfigurationSubject
    {
        ...
        Establish context = () =>
        {
            ...
            SystemTime.AdvanceTime(TimeSpan.FromSeconds(8).Subtract(TimeSpan.FromTicks(1)));
        };

        Because of = () => The<ITaskRepeater>().Start();

        It should_not_repeat_the_message = () => GetServer().SentMessages.Count.ShouldBeEquivalentTo(2);
    }
}