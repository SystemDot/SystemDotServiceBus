...
{
    public class when_a_stored_message_can_be_repeated_as_four_seconds_have_passed_after_the_fourth_attempt 
        : WithSubject<MessageRepeater>
    {
        ...
        It should_increase_the_amount_of_times_the_message_was_sent = () => processedMessage.GetAmountSent().ShouldEqual(5);
    }
}