...
namespace SystemDot.Messaging.Specifications.transport.http.received_message_return_address_reassignment
{
    ...
    public class when_receiving_a_reply_with_a_from_address_listed_on_the_sender : WithServerConfigurationSubject
    {
        ...
        It should_send_the_acknoweldgement_to_the_local_address_listed = () => 
            WebRequestor.DeserialiseSingleRequest<MessagePayload>()
                .GetToAddress().Server.Address.Path.ShouldEqual(LocalReceiverServerAddress);
    }
}