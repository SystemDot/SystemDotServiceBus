...
{
    public class when_configuring_a_server_with_a_secure_address_registered : WithHttpServerConfigurationSubject
    {
        ...
        It should_listen_a_url_based_on_the_machine_name = () =>
            TestHttpServer.Instance
                .Url.ShouldBeEquivalentTo(String.Concat("https://", ServerAddress, "/", ServerName, "/"));
    }
}